...
def main():
    ...
    #Ceiling
    for x in range(0,400,5): #Step is in centimeters
        for y in range(0,800,5):
            ...
            #We can add the powers in a vector, a long side the time it has arrived at.
            #but possibly we can also add the power contribution from each element and save it
    #print(Power_contribution_ceiling)
    ...
    for x in range(0,400,5): #Step is in centimeters
        for z in range(0,300,5):
            ...
            #Power_contribution_left[x,z] = Power_at_receiver
            Timing_contribution_left[x,z] = (Total_distance* 10**-2)  / Speed_of_light  #converting from cm to m first

            #We can add the powers in a vector, a long side the time it has arrived at.
            #but possibly we can also add the power contribution from each element and save it
    #print(Power_contribution_left)
    #print(count)
    ...
    for x in range(0,400,5): #Step is in centimeters
        for z in range(0,300,5):
            ...
            #Power_contribution_right[x,z] = Power_at_receiver
            Timing_contribution_right[x,z] = (Total_distance* 10**-2)  / Speed_of_light  #converting from cm to m first
    ...
    x = 0
    # front wall
    for y in range(0,800,5): #Step is in centimeters
        for z in range(0,300,5):
            count=count+1
            #Get distance form source
            current_element =np.array([x,y,z])
            ...
            #Power_contribution_front[y,z] = Power_at_receiver
            Timing_contribution_front[y,z] = (Total_distance* 10**-2)  / Speed_of_light  #converting from cm to m first
    ...
    for y in range(0,800,5): #Step is in centimeters
        for z in range(0,300,5):
            ...
            #Power_contribution_back[y,z] = Power_at_receiver
            Timing_contribution_back[y,z] = (Total_distance* 10**-2)  / Speed_of_light  #converting from cm to m first
    ...
    #calcChannelLOS(Rx,Tx,system_settings)
